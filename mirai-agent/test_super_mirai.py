...
"""
    ...
    print("\n📊 ИТОГОВАЯ СТАТИСТИКА:")
    print(f"   ✅ Поддерживаемых языков: {len(agent.multi_lang.get_supported_languages())}")
    print(f"   ✅ Баз данных: 4 (SQLite, PostgreSQL, Redis, MongoDB)")
    print(f"   ✅ Инструментов агента: 8 (execute_python, search_web, read_file, write_file, run_command, create_task, execute_code, database_query)")
