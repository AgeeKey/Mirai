...
run_component_tests() {
    ...
    cd modules/trading && python3 adaptive_strategies.py
    cd ../..
    
    # Тест брокерских коннекторов
    info "Тестирование брокерских коннекторов..."
    cd modules/trading && python3 broker_connectors.py
    cd ../..
    
    # Тест AI safety rules
    info "Тестирование AI safety rules..."
    cd modules/agent && python3 ai_safety_rules.py
    cd ../..
...
- **Файл**: `modules/trading/adaptive_strategies.py` (870+ строк)
- **Функции**: 
...
- **Файл**: `modules/trading/broker_connectors.py` (800+ строк)
- **Функции**:
...
- **Файл**: `modules/agent/ai_safety_rules.py` (650+ строк)  
- **Функции**:
