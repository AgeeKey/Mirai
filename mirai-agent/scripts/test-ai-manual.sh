...
check_file "modules/trading/agent_loop.py" "Enhanced Agent Loop"
check_file "modules/agent/policy.py" "AI Trading Policies"
...
if python3 -c "
try:
    from modules.trading.agent_loop import AIIntegratedTradingLoop, create_enhanced_trading_loop
...
if python3 -c "
try:
    from modules.agent.policy import AIEnhancedPolicy, PolicyEngine, MockLLMPolicy
...
try:
    from modules.trading.agent_loop import AIIntegratedTradingLoop
