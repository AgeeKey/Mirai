...
class DatabaseManager:
    ...
    async def postgres_query(self, query: str, params: tuple = None) -> List[Dict]:
        ...
        try:
            ...
            return [
                {
                    "error": "PostgreSQL драйвер не установлен. Установите: pip install psycopg2-binary"
                }
            ]
        except Exception as e:
            return [{"error": str(e)}]
    ...
    async def mongodb_find(
        self, collection: str, query: Dict = None, limit: int = 100
    ) -> List[Dict]:
        ...
        try:
            ...
            return [
                {
                    "error": "MongoDB драйвер не установлен. Установите: pip install pymongo"
                }
            ]
        except Exception as e:
            return [{"error": str(e)}]
    ...
    async def test_connection(self, db_type: str) -> Dict[str, Any]:
        ...
        results = {"database": db_type, "status": "unknown", "details": ""}
