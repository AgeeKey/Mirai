...
# async_task_result = await execute_async_task(<значение для param1>, <значение для param2>)

# Подробное логирование результата выполнения:
# logging.info(f"Результат выполнения: {async_task_result}")
