...
# Пример использования функции (заменен на корректный вид)
# async_task_result = await execute_async_task(1, 2)
# print(async_task_result) # Для проверки результата выполнения