...
def test_github_integration_learning():
    ...
    if research_artifact:
        ...
        print(f"   - GitHub search attempted: {metadata.get('github_search_attempted', False)}")
    ...
    success_criteria = [
        ...
        ("GitHub search attempted", research_artifact and research_artifact.metadata.get('github_search_attempted', False)),
