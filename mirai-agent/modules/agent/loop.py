...
class AgentLoop:
    ...
    def __init__(self, trading_client, risk_params: Optional[RiskParameters] = None, notifier=None):
        ...
        # Advisor state / configuration
        self._config = Config.load()
        self.agent_settings = self._config.agent_settings
        self.advisor_config = get_advisor_config()
    ...
    def make_decision(self, symbol: str = "BTCUSDT") -> dict[str, Any]:
        ...
        try:
            ...
            if not self.policy_engine.evaluate_risk(final_decision, self.positions):
