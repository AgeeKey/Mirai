...
logger = Logger("AdvisorReports").logger
        ...
        report = {
            ...
            "summary": {
                ...
                "filtered_by_advisor_percent": self._calculate_percentage(
                    daily_stats["filtered_by_advisor"], daily_stats["total_decisions"]
                ),
            },
...
"""
    ...
    def _analyze_advisor_effectiveness(self, daily_stats: dict[str, Any]) -> dict[str, Any]:
        ...
        daily_decisions = [d for d in recent_decisions if d.get("ts", "").startswith(date_str)]
