...
PROJECT_ROOT = Path(os.getenv("MIRAI_AGENT_HOME", str(Path(__file__).resolve().parents[2])))
DEFAULT_MEMORY_DB = PROJECT_ROOT / "state" / "agent_memory.db"
DEFAULT_LOG_FILE = PROJECT_ROOT / "logs" / "ai_agent.log"
...
class AgentConfig:
    ...
    # Пути к файлам
    memory_db_path: str = str(DEFAULT_MEMORY_DB)
