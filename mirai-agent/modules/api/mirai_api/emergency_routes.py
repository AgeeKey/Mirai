...
from typing import Optional, Dict as _DictAny
import json
import os
...
EMERGENCY_STATE: _DictAny[str, object] = {
...
class EmergencyStopManager:
    ...
    async def stop_trading_signals(self):
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                await client.post("http://localhost:8080/emergency/pause")
    ...
    async def stop_ai_orchestrator(self):
        ...
        try:
            import httpx
            async with httpx.AsyncClient() as client:
                await client.post("http://localhost:8080/emergency/stop")
...
async def emergency_stop(
    ...
    background_tasks.add_task(
        emergency_manager.execute_emergency_stop,
