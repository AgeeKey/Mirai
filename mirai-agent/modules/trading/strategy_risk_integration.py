...
from .advanced_risk_engine import (
    AdvancedRiskEngine,
    PositionType,
)
from .ai_safety_layers import AISafetySystem
from .strategies.technical.base_strategy import (
    BaseTradingStrategy,
    StrategyParams,
)
...
class StrategyRiskManager:
    ...
    async def process_market_data(self, symbol: str, price_data: Dict) -> Dict:
                ...
                try:
                    ...
                    if signal:
                        ...
                        if validated_signal:
                            ...
                            risk_metrics_dict = asdict(await self.risk_engine.calculate_risk_metrics())
        ...
        risk_metrics_obj = await self.risk_engine.calculate_risk_metrics()
        risk_metrics_dict = asdict(risk_metrics_obj)
        risk_metrics_dict['risk_level'] = risk_metrics_obj.risk_level.value  # Enum в строку
