...
class OrderManager:
    ...
    def cancel_order(self, symbol: str, order_id: str) -> dict[str, Any]:
        ...
        try:
            client_any = cast(Any, self.client.client)
            result = client_any.cancel_order(symbol=symbol, orderId=order_id)
    ...
    def get_order_status(self, symbol: str, order_id: str) -> dict[str, Any]:
        ...
        try:
            client_any = cast(Any, self.client.client)
            return client_any.query_order(symbol=symbol, orderId=order_id)
        except Exception as e:
