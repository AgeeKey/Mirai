...
class RiskEngine:
    ...
    def allow_entry(self, now_utc: datetime, symbol: str, account_state: Optional[dict[str, Any]] = None) -> tuple[bool, str]:
        """
    ...
    def record_fill(self, ts: str, symbol: str, side: str, qty: float, price: float, pnl: float):
        ...
        def reset_day_state(self, date_utc: Optional[str] = None):
