...
class PerformanceAnalyzer:
    ...
    def _analyze_trading_performance(self, trade_records: List, strategy_name: str) -> Dict:
        ...
        _losing_trades = len([pnl for pnl in pnls if pnl < 0])
    ...
    def _analyze_from_risk_events(self, risk_events: List, strategy_name: str) -> Dict:
        ...
        if total_events == 0:
            performance_score: float = 70.0  # Нейтральный уровень
        else:
            ...
            performance_score = max(0.0, 100.0 - critical_ratio * 50.0 - warning_ratio * 25.0)
